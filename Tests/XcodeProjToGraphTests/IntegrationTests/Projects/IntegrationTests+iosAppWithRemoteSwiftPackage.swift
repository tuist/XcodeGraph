...
extension IntegrationTests {
    @Test
    func projectNoWorkspace() async throws {
        let path = try WorkspaceFixture.iosAppWithRemoteSwiftPackage.absolutePath()
        let graph: XcodeGraph.Graph = try await ProjectParser.parse(projectType: .xcodeProject(path))
